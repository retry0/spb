...
Future<void> configureDependencies() async {
  ...
  // QR Code use cases
  getIt.registerLazySingleton(
    () => GenerateQrCodeUseCase(getIt<QrCodeRepository>()),
  );
  getIt.registerLazySingleton(
    () => SaveQrCodeUseCase(getIt<QrCodeRepository>()),
  );
  getIt.registerLazySingleton(
    () => GetSavedQrCodesUseCase(getIt<QrCodeRepository>()),
  );
  getIt.registerLazySingleton(
    () => ExportQrCodeUseCase(getIt<QrCodeRepository>()),
  );
  getIt.registerLazySingleton(
